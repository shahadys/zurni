            ...
            for ($j = 0 ; $j < $rows ; ++$j)
              {
                ...
                echo '<h4>'   . $result->fetch_assoc()['Name']   . '</h4><br><a href="'.$result1->fetch_assoc()['url'].'" style="color:white; background-color:#57b750; text-decoration: none; border-radius:5px; padding: 5px 25px 5px 25px;">View Profile</a></div>';
              }
         ?>
    </div>
